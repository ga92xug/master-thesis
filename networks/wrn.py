...
class NetworkBlock(nn.Module):
    ...
    def _make_layer(self, block, in_planes, out_planes, nb_layers, stride, dropRate):
        ...
        for i in range(int(nb_layers)):
            #                   in_planes                     , out_planes, stride                , dropRate
...
class WideResNet(nn.Module):
    def __init__(self, depth, layout, kernel_size, padding, input_channels, \
                 num_classes, widen_factor=1, dropRate=0.0):
        ...
        self.conv1 = nn.Conv2d(input_channels, nChannels[0], kernel_size=3, stride=1,
                               padding=1, bias=False)
        # 1st block
        self.layer1 = NetworkBlock(n, nChannels[0], nChannels[1], block, 1, dropRate)
        # 2nd block
...
if __name__ == '__main__':
    ...
    net = WideResNet(depth=16, input_channels=3, layout=(16,32,64), num_classes=10, widen_factor=4, dropRate=0.3)
