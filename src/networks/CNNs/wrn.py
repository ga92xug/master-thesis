...
class WideResNet(nn.Module):
    def __init__(self, depth, layout, kernel_size, kernel_layout, padding, num_channels, \
        ...
        self.conv1 = nn.Conv2d(num_channels, nChannels[0], kernel_size=kernel_size, stride=1,
                               padding=1, bias=bias)
