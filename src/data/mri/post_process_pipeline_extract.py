...
class Clinica_Connector:
    def __init__(self, run_pipeline: bool, pipeline: str = "t1-volume-tissue-segmentation", n_threads: int = 8):
        ...
        self.converted_path = os.path.join(PATH, "converted_subjects_linear.tsv")
        self.skipped_path = os.path.join(PATH, "skipped_sessions_linear.tsv")
...
def main(run_pipeline: bool, path: str, filter_type: str):
    ...
    BIDS_PATH = os.path.join(PATH, "bids_linear")
    TSV_PATH = os.path.join(PATH, "temp_linear.tsv")
    CAPS_PATH = os.path.join(PATH, "caps_linear")
    SLICE2DDATA = os.path.join(PATH, "slice2Ddata")
