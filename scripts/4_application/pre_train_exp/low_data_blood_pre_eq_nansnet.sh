...
# 0.05
$PY_SCRIPT -m experiment=application/HPs_blood/eq_nasnet \
    train.dataset.reduction_factor=0.05 \
    train.trainer.max_epochs=350 train.callbacks.early_stopping.patience=50 \
    $PRE_TRAINED train.network.dropout_rate=0.5,0.2
...
$PY_SCRIPT -m experiment=application/HPs_blood/eq_nasnet \
    train.dataset.reduction_factor=0.05 \
    train.trainer.max_epochs=100 train.callbacks.early_stopping.patience=50 \
...
# 0.3
$PY_SCRIPT experiment=application/HPs_blood/eq_nasnet \
