...
$PY_SCRIPT -m experiment=scaling/all \
    train/network/blocks_args_dict=3blocksD1,4blocksD1 \
    $SEEDS 

# resolution
$PY_SCRIPT -m experiment=scaling/all \
    train/network/blocks_args_dict=3blocksD1,4blocksD1 \
    train.dataset.resolution=128,192,224 \
    $SEEDS \
...
# 3 blocks
$PY_SCRIPT -m experiment=scaling/all \
    train/network/blocks_args_dict=3blocksD1 \
...
# 4 blocks
$PY_SCRIPT -m experiment=scaling/all \
    train/network/blocks_args_dict=4blocksD1 \
    train.network.blocks_args_dict._3.num_layers=3 \
