...
args = ["model.restrict=[halved, invariant]", "model.kernel_layout=[5,5]", "model.padding=2", "model.depth=16", "model.widen_factor=4", "wandb.tags=[rotation_exp_1]", "wandb.notes=rot8"]
