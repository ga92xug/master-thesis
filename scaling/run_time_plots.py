...
from experiment.network_instantiation import extract_info_instantiate_network, main
...
def main():
    ...
    for depth in range(6, 48, 6):
        ...
        param_count, model_building_time, train_time, gflops = extract_info_instantiate_network(output)
