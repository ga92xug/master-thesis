...
# Flip wrt an axis ######################################
def dn_to_flip(axis: int, flip: CyclicGroup):
...
# Dihedral Group ######################################
def dn_to_dm(axis: int, dm: DihedralGroup):
