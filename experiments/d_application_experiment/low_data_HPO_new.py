...
def get_HPO_name(name_hpo: str, cfg: DictConfig):
    global_overrides = cfg.dataset.global_overrides
    name = f"{name_hpo}_{cfg.dataset.name}_"\
...
@hydra.main(config_path="3_low_data_regime", config_name="HPO", version_base="1.2")
