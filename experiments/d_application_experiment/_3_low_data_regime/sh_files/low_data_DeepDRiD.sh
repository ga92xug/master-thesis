...
# 0.1
$PY_SCRIPT -m other.seed=4 '+exp_HPs_DeepDRiD=glob(*)' \
    wandb.tags=[Blood_low_data] other.should_test=True \
    training.dataset.reduction_factor=0.1 \
    training.epochs=450 training.earlystop.patience=80

exit 0

# 1
$PY_SCRIPT -m other.seed=0,1,2,3,4 +exp_HPs_DeepDRiD=efficientnet \
    wandb.tags=[Blood_low_data] other.should_test=True \
