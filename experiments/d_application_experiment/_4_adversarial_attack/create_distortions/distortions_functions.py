# adapted from https://raw.githubusercontent.com/hendrycks/robustness/master/ImageNet-C/create_c/make_cifar_c.py
...
def get_distortions_dict() -> collections.OrderedDict:
